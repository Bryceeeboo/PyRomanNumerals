...
def convertToRoman(number):
    ...
    NOTE - This function is NOT used. This represents the expanded version of
    the smaller and more efficient OOMR function.
    """
...
def getValidInput():
    ...
    while True:
        ...
        except Exception:  # If the input can't be converted
